 ...
 * @return *CallLogFull
 */
func (a CalllogsApi) GetAccountCallLogs(accountId int32, callId string) (*CallLogFull, *APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/accounts/{account_id}/call-logs/{call_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"account_id"+"}", fmt.Sprintf("%v", accountId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"call_id"+"}", fmt.Sprintf("%v", callId), -1)
	...
	var localVarAPIResponse = &APIResponse{Operation: "GetAccountCallLogs", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
